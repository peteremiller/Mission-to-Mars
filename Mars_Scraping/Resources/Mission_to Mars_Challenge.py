...
#browser = Browser('chrome', **executable_path, headless=T)
...
#slide_elem = news_soup.replace_one('ul.item_list li.slide')
...
# find the relative image url
img_url_rel = img_soup.replace_one('figure.lede a img').get("src")
img_url_rel
...
html = browser.html
img_soup =soup(html, 'html.parser')
url = soup.find_all('div', class_='item')
titles=[]
